 ...
 *                                                                           *
 *    Description: Beautiful console logger for ᴵ ᴬᴹ ᴸᴱᴳᴱᴺᴰ WhatsApp Bot     *
 *                                                                           *
 ***************************************************************************/
...
async function printMessage(message, sock) {
    try {
        ...
        // Detect if the message is a bot response (using config.botName)
        const isBotResponse = messageText.includes(config.botName) ||
