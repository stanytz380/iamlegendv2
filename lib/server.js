 ...
 *                                                                           *
 *    Description: Express server for ᴵ ᴬᴹ ᴸᴱᴳᴱᴺᴰ WhatsApp Bot              *
 *                                                                           *
 ***************************************************************************/
...
const packageInfo = {
    name: config.botName || 'ᴵ ᴬᴹ ᴸᴱᴳᴱᴺᴰ',
    version: config.version || '6.0.0',
    description: config.description || 'High performance WhatsApp bot by STANY TZ',
...
app.get('/', (req, res) => {
    ...
    <body>
        <div class="container">
            ...
            <footer>POWERED BY STANY TZ</footer>
        </div>
    </body>
    </html>
    `);
